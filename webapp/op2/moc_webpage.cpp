...
**
** Created: Fri Aug 2 00:23:55 2013
...
static const char qt_meta_stringdata_WebPage[] = {
    "WebPage\0\0url\0loadingUrl(QUrl)\0frame\0"
    "handleFrameCreated(QWebFrame*)\0reply\0"
    "handleUnsupportedContent(QNetworkReply*)\0"
    "bool\0type,args\0replayEvent(int,QByteArray)\0"
};
...
void WebPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->handleFrameCreated((*reinterpret_cast< QWebFrame*(*)>(_a[1]))); break;
        case 2: _t->handleUnsupportedContent((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        case 3: { bool _r = _t->replayEvent((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QByteArray(*)>(_a[2])));
