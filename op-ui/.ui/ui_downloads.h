...
public:
    ...
    void setupUi(QDialog *DownloadDialog)
    {
        ...
        downloadsView->setFrameShape(QFrame::NoFrame);
        ...
        closeButton = new QPushButton(DownloadDialog);
    ...
    void retranslateUi(QDialog *DownloadDialog)
    {
        ...
        closeButton->setText(QApplication::translate("DownloadDialog", "&OK", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
